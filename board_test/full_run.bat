...
py.test -vv --html=reports/test_results_none.html -k "not fwd_received"
echo Press STM reset button
pause
py.test -vv --html=reports/test_results_none_fwd_received.html -k fwd_received
...
pause
py.test -vv --html=reports/test_results_mbed.html -D mbed test_mbed_only.py test_board_mbed.py -k "not tx"
echo Press STM reset button
pause
